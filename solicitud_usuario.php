...
<form action="solicituduser.php" class="selector-row">
    <p class="label-text">Tipos de Requerimiento:</p>
    <div class="button-group">
        <label class="button">
            <input type="radio" name="eleccion" value="incidencia" checked>
            Incidencia
        </label>
        <label class="button">
            <input type="radio" name="eleccion" value="solicitud">
            Solicitud
        </label><br>
    ...
    <select name="equipos" id="equipos">
        <option value="pc_sobremesa">PC Sobremesa</option>
